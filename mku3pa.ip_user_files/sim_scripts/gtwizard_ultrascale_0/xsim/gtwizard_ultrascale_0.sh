...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L xpm -L gtwizard_ultrascale_v1_7_5 -L unisims_ver -L unimacro_ver -L secureip --snapshot gtwizard_ultrascale_0 xil_defaultlib.gtwizard_ultrascale_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim gtwizard_ultrascale_0 -key {Behavioral:sim_1:Functional:gtwizard_ultrascale_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_9054.protoinst" -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(gtwizard_ultrascale_v1_7_5)
